...
<head>
	...
	<script>
		function addСompare(login, password) {
			var str = "autoris="+login+password;
			$.ajax({
				type:"post",
				url: "aut",
				data: str,
...
<body>
	...
	<table style="margin:0 auto;">
		...
		<tr>
				<th><a href="aut"><button onclick='addСompare(document.getElementById("log").value,document.getElementById("pass").value)' type="submit">Войти</button></a></th>
		</tr>
	</table>
</body>
</html>